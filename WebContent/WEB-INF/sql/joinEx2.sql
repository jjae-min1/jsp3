...
SELECT s.grade FROM employee e, salgrade s WHERE e.salary BETWEEN 
			s.losal AND s.hisal AND e.eno = 7839;

SELECT e.ename FROM employee e, salgrade s 
			WHERE e.salary BETWEEN s.losal AND s.hisal AND s.grade = 5;
